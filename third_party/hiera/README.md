# Pinned commit:
```
commit b12b842542ee5c757fcfec8c41f6b56fcbe89b65 (HEAD -> main, origin/main, origin/HEAD)
Author: Daniel Bolya <dbolya@gmail.com>
Date:   Sat Mar 2 01:16:12 2024 -0500

    [v0.1.4] Updated the license section of the README.

commit 1a7b053886aadefcf218cb4e497f62b3dae7687c
Author: Daniel Bolya <dbolya@gmail.com>
Date:   Sat Mar 2 01:06:50 2024 -0500

    [v0.1.4] Fixed badges in README.

commit 15aa1c1f3a9cf5861d944053856e7cbc354eb0d9 (tag: v0.1.4)
Author: Daniel Bolya <dbolya@gmail.com>
Date:   Sat Mar 2 00:51:05 2024 -0500

    [v0.1.4] Updated code license to Apache 2.0. (#29)
    
    * [v0.1.4] Changed code license to Apache 2.0.
