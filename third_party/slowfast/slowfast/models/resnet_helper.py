...
class BottleneckTransform(nn.Module):
    ...
    def _construct(
        ...
        self.a = nn.Conv3d(
            ...
            stride=[str1x1 if temporal_stride else 1, str1x1, str1x1],
        ...
        self.b = nn.Conv3d(
            ...
            dim_inner,
            [1, 3, 3],
            stride=[str3x3 if temporal_stride else 1, str3x3, str3x3],
            padding=[0, dilation, dilation],
            groups=num_groups,
            bias=False,
            dilation=[1, dilation, dilation],
    ...
    def _construct(
        ...
        if (dim_in != dim_out) or (stride != 1):
            self.branch1 = nn.Conv3d(
                ...
                dim_out,
                kernel_size=1,
                stride=[stride if temporal_stride else 1, stride, stride],
                padding=0,
                bias=False,
                dilation=1,
            )
