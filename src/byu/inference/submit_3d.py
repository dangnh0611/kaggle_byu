...
EXP23_X3DM_ALLGTV3 = {
    "backend": "torch",  # torch | trt
    "trt_path": "assets/EXP23_X3DM_ALLGTV3_ep2_step36000.engine",
    "config_path": "assets/EXP23_X3DM_ALLGTV3_config.yaml",
    "torch_path": "assets/EXP23_X3DM_ALLGTV3_ep2_step36000.ckpt",
    "ema": 0.99,
}

EXP28_DENSNET121_ALLGTV3 = {
    "backend": "torch",  # torch | trt
    "trt_path": "assets/EXP28_DENSNET121_ALLGTV3_ep=1_step=32000.engine",
    "config_path": "assets/EXP28_DENSNET121_ALLGTV3_config.yaml",
    "torch_path": "assets/EXP28_DENSNET121_ALLGTV3_ep=1_step=32000.ckpt",
    "ema": 0.99,
}

EXP31_RESNEXT50_ALLGTV3 = {
    "backend": "torch",  # torch | trt
    "trt_path": "assets/EXP31_RESNEXT50_ALLGTV3_ep=1_step=32000.engine",
    "config_path": "assets/EXP31_RESNEXT50_ALLGTV3_config.yaml",
    "torch_path": "assets/EXP31_RESNEXT50_ALLGTV3_ep=1_step=32000.ckpt",
    "ema": 0.99,
}
...
JOBS = [
    [
        {
            "sig": EXP23_X3DM_ALLGTV3,
            "tta": ["zyx", "zxy"],
            "weight": [1.0, 1.0],
            "agg_name": ["X3D-zyx", "X3D-zxy"],
        },
        {
            "sig": EXP28_DENSNET121_ALLGTV3,
            "tta": ["zyx_x", "zyx_y"],
            "weight": [1.0, 1.0],
            "agg_name": ["DENSENET121-zyx_x", "DENSENET121-zyx_y"],
        },
        {
            "sig": EXP31_RESNEXT50_ALLGTV3,
            "tta": ["zyx_z", "zxy_z"],
            "weight": [1.0, 1.0],
            "agg_name": ["RESNEXT50-zyx_z", "RESNEXT50-zxy_z"],
        },
    ]
]
...
all_unique_agg_weights = {
    "DENSENET121-zyx_x": 1.0,
    "DENSENET121-zyx_y": 1.0,
    "RESNEXT50-zxy_z": 1.0,
    "RESNEXT50-zyx_z": 1.0,
    "X3D-zxy": 1.0,
    "X3D-zyx": 1.0,
